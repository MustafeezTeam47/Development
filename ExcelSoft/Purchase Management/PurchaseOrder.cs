...
namespace ExcelSoft.Purchase_Management
{
    ...
    public partial class PurchaseOrder : Form
    {
        ...
        public PurchaseOrder()
        {
            ...
            PurchaseOrderGrp.Location = new Point(
             this.ClientSize.Width / 2 - PurchaseOrderGrp.Size.Width / 2,
             this.ClientSize.Height / 2 - PurchaseOrderGrp.Size.Height / 2);
            PurchaseOrderGrp.Anchor = AnchorStyles.None;
        }
        ...
        public void GetMainGridTable()
        {
            ...
            _datatable.Columns.Add("RequestedQuantity", typeof(decimal));
        ...
        private void AddNewRow()
        {
            ...
            _datarowmain["RequestedQuantity"] = 0.00;
            ...
            this.PurchaseOrderGrid.DataSource = _datatable;
        }
