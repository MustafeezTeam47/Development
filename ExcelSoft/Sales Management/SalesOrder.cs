...
namespace ExcelSoft.Sales_Management
{
    public partial class SalesOrder : Form
    {
        ...
        {
            InitializeComponent();
            this.Text = "Sales Order - ( New )";
            SalesOrderGrp.Location = new Point(
            this.ClientSize.Width / 2 - SalesOrderGrp.Size.Width / 2,
            this.ClientSize.Height / 2 - SalesOrderGrp.Size.Height / 2);
            SalesOrderGrp.Anchor = AnchorStyles.None;
        }
        ...
        private void AddNewRow()
        {
            ...
            this.SalesOrderGrid.DataSource = _datatable;
        }
