...
namespace ExcelSoft.Inventory_Management
{
    public partial class StockAdjustment : Form
    {
        ...
        {
            InitializeComponent();
            this.Text = "Stock Adjustment - ( New )";
            StockAdjustGrp.Location = new Point(
             this.ClientSize.Width / 2 - StockAdjustGrp.Size.Width / 2,
             this.ClientSize.Height / 2 - StockAdjustGrp.Size.Height / 2);
            StockAdjustGrp.Anchor = AnchorStyles.None;
        }
        ...
        public void GetMainGridTable()
        {
            ...
            _datatable.Columns.Add("StockType", typeof(string));
        ...
        private void AddNewRow()
        {
            ...
            this.StockAdjustGrid.DataSource = _datatable;
        }
